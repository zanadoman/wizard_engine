...
uint8_t
wze::timer::get_frametime(void)
{
    return timer::frametime;
}

void
wze::timer::set_frametime(uint8_t frametime)
{
    timer::frametime = frametime;
}

uint8_t
wze::timer::get_deltatime(void)
{
    return timer::deltatime;
}

void
wze::timer::set_deltatime(uint8_t deltatime)
{
    timer::deltatime = deltatime;
}

uint64_t
wze::timer::get_time(void)
{
    return SDL_GetTicks64();
}

void
wze::timer::_update(void)
{
    uint32_t deadline;
