...
float
wze::math::angle(float init_x, float init_y, float term_x, float term_y)
{
    float result;
...
float
wze::math::move_x(float distance, float angle)
{
    return distance * cosf(angle);
}

float
wze::math::move_y(float distance, float angle)
{
